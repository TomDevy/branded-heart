        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              We create premium branding solutions for businesses and
              individuals that want to stand out. Quality materials, innovative
              designs, and sustainable practices.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://web.facebook.com/brandedheartcreationsTshirtRepublic/?_rdc=1&_rdr#"
              ...
              <a
                href="https://www.instagram.com/bh_creation/"
                className="text-gray-300 hover:text-primaryRed transition-colors"
              >
                {/* Instagram icon */}
                <svg
              ...
              <a
                href="https://wa.me/2347061934336"
                target="_blank"
